...
const InvoiceForm = () => {
  ...
  const handleSubmit = async (formData) => {
    ...
    try {
      ...
      console.log('Invoice data to submit:', formData)
      
      // Show success message
      alert(isEditMode ? 'Invois berjaya dikemaskini!' : 'Invois berjaya dicipta!')
      
      // Navigate back to invoices list
      navigate('/invoices')
    } catch (error) {
      console.error('Error submitting invoice:', error)
      alert('Ralat berlaku semasa menyimpan invois. Sila cuba lagi.')
    } finally {
      setSubmitting(false)
    }
  }
