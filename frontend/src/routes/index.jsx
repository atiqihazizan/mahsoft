...
import DeliveryOrderPreview from '../pages/DeliveryOrderPreview.jsx'
...
const router = createBrowserRouter([
  ...
  // Semua modul dengan PageLayout
  {
    ...
    children: [
      ...
      { path: '/delivery-orders/:id', element: <DeliveryOrderPreview /> },
